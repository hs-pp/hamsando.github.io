...
On the 2XKO team I am the tech lead for UI architecture as well as a significant contributor for the around game features built on to of the UI.
I recently gave a GDC talk about our UI architecture which you can read about here:
{% include page-link.html slug="gdc-talk-lessons-in-ui-2xko"%}
        
I also greatly enjoy building and improving developer workflows by building editor tools in both Unity and Unreal Editor.
Most of my personal projects are developer tools built in Unity. Check out my latest tool here:
{% include page-link.html slug="08-devstats"%}
